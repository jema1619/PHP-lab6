...
#we can create a function to add comment_table
#basically it inserts a comment in a database.

function add_comment($comment){
    
    
@ $db = new mysqli('localhost', 'root', '', 'marina');
...
$query = ("INSERT INTO comment_table(comment) VALUES ('{$comment}')");
...
#then we create a function to pull out all comment_table
#it goes in the database and pulls out all comment_table.

function get_comment(){
    
@ $db = new mysqli('localhost', 'root', '', 'marina');
    
$query = ("SELECT comment FROM comment_table");
$stmt = $db->prepare($query);
...
#here we call all comment_table to be shown by simply calling the get_comment function
get_comment();
